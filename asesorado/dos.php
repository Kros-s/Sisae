...
<div id="container">
  <div id="Ajax_API"><?php
	echo "Te has logueado con este nombre: " . $_SESSION['usuario'];
	echo"<br>";
	?>
  Dentro de esta parte podras encontrar toda la parte que es necesaria para realizar tus Asesorias.</div>
  <div id="contTleft">
