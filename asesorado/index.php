...
<script type="text/javascript" src="../javascript/index_asesorado.js"></script>
...
<div id="container">
  <div id="Ajax_API"><h3>MENU</h3>
      <input type="image" name="date" id="date" src="../icos/note_accept.png" title="MOSTRAR ASESORIAS ACTUALES" />
         <input name="solicited" type="image" id="solicited" src="../icos/page_add.png" alt="SOLICITAR ASESORIAS" />
